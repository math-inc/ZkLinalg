...
\begin{lemma}[Chaining]\label{lem:chaining_probabilistic}\leanok \lean{ZkLinalg.chaining_probabilistic}
...
\begin{lemma}[Contrapositive]\label{lem:contrapositive_probabilistic}
\uses{def:probabilistic_implication}
...
\begin{lemma}[Conjunction]\label{lem:conjunction_probabilistic}\leanok \lean{ZkLinalg.conjunction_probabilistic}
\uses{def:probabilistic_implication}
...
\begin{lemma}[Reed-Solomon Distance]\label{lem:reed_solomon_distance}\leanok \lean{ZkLinalg.reed_solomon_distance}
...
\begin{lemma}[Hadamard Distance]\label{lem:hadamard_distance}\leanok \lean{ZkLinalg.hadamard_distance}
...
\begin{lemma}[Zero Check]\label{lem:zero_check}\leanok \lean{ZkLinalg.zero_check}
...
\uses{lem:zero_check} \lean{ZkLinalg.matrix_zero_check}
...
\begin{lemma}[Reduced Matrix Zero Check]\label{lem:reduced_matrix_zero_check}\leanok \lean{ZkLinalg.reduced_matrix_zero_check}
...
\begin{lemma}[Polynomial Zero Check Corollary]\label{lem:polynomial_zero_check}\leanok \lean{ZkLinalg.polynomial_zero_check}
...
\begin{lemma}[Sparsity Check]\label{lem:sparsity_check}\leanok \lean{ZkLinalg.sparsity_check}
...
\begin{lemma}[Matrix Sparsity Check]\label{lem:matrix_sparsity_check}\leanok \lean{ZkLinalg.matrix_sparsity_check}
\uses{lem:zero_check}
...
\begin{lemma}[Unique Decoding Radius]\label{lem:unique_decoding_radius}\leanok \lean{ZkLinalg.unique_decoding_radius}
...
\begin{definition}[FRI Subspace Structure]\label{def:fri_subspace_structure} \leanok
